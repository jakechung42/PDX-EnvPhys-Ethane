...
;This next section will read in the deseasonal values of the NOAA data from the deseason_noaa_main program ASCII file
...
print, ogi_ihr_err1, nor_ogi_err, sou_ogi_err
...
for x = 0, 5 do begin;<<<<Begining of a big loop to go through all the scenarios
...
open_device, /ps, /color, file='temp.eps', /landscape, set_resolution = [ 1080, 720 ], margin=0.05
!p.font=0
!p.charsize=0.3



cgplot, noaa_time, nor_noaa, /nodata, yrange = [ 200 , 1400 ], xrange = [ 1982 , 2016 ], charsize = 1.2
...
AL_Legend, ['Default Scenario', 'Scenario B', 'Scenario C', 'Scenario D', 'Scenario E', 'Scenario F'], $	
	color = ['violet', 'forest green', 'blue', 'blue', 'red', 'red'], $
	psym = [ -3, -3, -3, -3, -3, -3], linestyle = [ 0, 0, 2, 0, 2, 0 ], /box, $
	position = [ 1982, 900 ], charsize = 0.7, background_color = 'white'
	
;Plotting IHR
cgplot, noaa_time, nor_noaa, /nodata, yrange = [ 2 , 5 ], xrange = [ 1982 , 2016 ], charsize = 1.2
...
AL_Legend, ['Default Scenario', 'Scenario B', 'Scenario C', 'Scenario D', 'Scenario E', 'Scenario F'], $	
	color = ['violet', 'forest green', 'blue', 'blue', 'red', 'red'], $
	psym = [ -3, -3, -3, -3, -3, -3], linestyle = [ 0, 0, 2, 0, 2, 0 ], /box, $
	position = [ 1982, 3 ], charsize = 0.7, background_color = 'white'
