PRO TEMPORAL_IHR_SAMPLING_SENSITIVITY
...
print, temp_global_ihr1, temp_global_nor1, temp_global_sou1
...
cgplot, noaa_time, nor_noaa, /nodata, yrange = [ 200 , 1500 ], xrange = [ 1982 , 2015 ], charsize = 1.3, $
...
AL_Legend, ['NOAA Network', 'UCI Network', 'OGI Network', 'Barrow/Samoa', $
	'Global'], $
	color = ['blue', 'red', 'forest green', 'blueviolet','black'], $
	linestyle = [0,0,0,0,0], position = [1983, 820], charsize = 1.2, box = 0
...
;Plotting IHR
cgplot, noaa_time, nor_noaa, /nodata, yrange = [ 3 , 6.5 ], xrange = [ 1982 , 2015 ], charsize = 1.3, $
	ytitle = 'IHR(NHM/SHM)'
...
;AL_Legend, ['NOAA Simulated IHR', 'UCI Simulated IHR', 'OGI Simulated IHR', 'Global Simulated IHR', $
;	'Barrow/Samoa Simulated IHR'], $
;	color = ['blue', 'red', 'forest green','BLUEVIOLET','black'], $
;	linestyle = [0,0,0,2,0], position = [1983,5], charsize = 1.0, box = 0
multiplot, /doyaxis, /doxaxis
