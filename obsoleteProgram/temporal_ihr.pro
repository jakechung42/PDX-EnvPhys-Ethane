...
;This version is built upon temporal_ihd_v5, which analyze the ethane 
;record and simulated using the 6-band method. 
...
for i = 0, noaa_ids_size - 1 do begin
	...
	;it will not write false values
...
;This next section will read in the deseasonal values output of the NOAA data from the deseason_noaa_main program 
...
;================================================================================
;PART 5: HANDLE THE SIMULATED DATA WITH THE SAME CALCULATIONS THAT WERE APPLIED TO THE OBSERVED DATA
;================================================================================
...
;this changes the latitudes and longitudes values of the stations in the NOAA, UCI and OGI
;data to index values in the simulated data
...
;call the simulated data out from the simArr, based on coordinates and time period
;FIRST, call out the correct time period.
;The data is averaged in one dimension over the specific time period
;of bin01 to bin05
...
;This loop is to run through the bins to have the calculations done without much copy and paste
for i = 0, 4 do begin
...
;This section calculate weighted mean for the sim data at UCI locations
;The weight is the deseasoned data
temp_weight_arr = cos(75*rad) / ( temp_arr[ 1 , band1 ] ) ^ 2
...
cgplot, noaa_time, nor_noaa, /overplot, psym = 2, color = 'blue', err_yhigh = nor_noaa_err, $
	err_ylow = nor_noaa_err, symsize = 1.2
cgplot, noaa_time, sou_noaa, /overplot, psym = 2, color = 'blue', err_yhigh = sou_noaa_err, $
	err_ylow = sou_noaa_err, symsize = 1.2
cgplot, ss_time, nor_ss, /overplot, psym = 5, color = 'red', err_yhigh = nor_ss_err, $
	err_ylow = nor_ss_err, symsize = 1.2
cgplot, ss_time, sou_ss, /overplot, psym = 5, color = 'red', err_yhigh = sou_ss_err, $
	err_ylow = sou_ss_err, symsize = 1.2
cgplot, ogi_time, nor_ogi, /overplot, psym = 4, color = 'forest green', err_yhigh = nor_ogi_err, $
	err_ylow = nor_ogi_err, symsize = 1.2
cgplot, ogi_time, sou_ogi, /overplot, psym = 4, color = 'forest green', err_yhigh = sou_ogi_err, $
	err_ylow = sou_ogi_err, symsize = 1.2
;the followings are plotting procedure for simulated data 
;cgplot, noaa_time, nor_noaa_sim, /overplot, psym = -3, color = 'blue'
;cgplot, noaa_time, sou_noaa_sim, /overplot, psym = -3, color = 'blue'
;cgplot, ss_time, nor_ss_sim, /overplot, psym = -3, color = 'red'
;cgplot, ss_time, sou_ss_sim, /overplot, psym = -3, color = 'red'
;cgplot, ogi_time, sou_ogi_sim, /overplot, psym = 5, color = 'forest green'
;cgplot, ogi_time, nor_ogi_sim, /overplot, psym = 5, color = 'forest green'
cgplot, all_time, global_nor, /overplot, color = 'black'
cgplot, all_time, global_sou, /overplot, color = 'black'
cgplot, all_time, global_nor_ss, /overplot, color = 'red', linestyle = 2
cgplot, all_time, global_sou_ss, /overplot, color = 'red', linestyle = 2
cgplot, all_time, global_nor_noaa, /overplot, color = 'blue', linestyle = 2
cgplot, all_time, global_sou_noaa, /overplot, color = 'blue', linestyle = 2
cgplot, all_time, global_nor_ogi, /overplot, color = 'forest green', linestyle = 2
cgplot, all_time, global_sou_ogi, /overplot, color = 'forest green', linestyle = 2

AL_Legend, ['NOAA data', 'UCI data', 'OGI data', 'NOAA sim', 'UCI sim', 'OGI sim', 'Sim Global' ], $
	color = ['blue', 'red', 'forest green', 'blue', 'red', 'forest green', 'black'], $
	psym = [ 2, 5, 4, -3, -3, -3, -3], linestyle = [ 0, 0, 0, 2, 2, 2, 0], /box, $
	background_color = 'rose', position = [ 1981, 850 ]
;Plotting IHR
cgplot, noaa_time, nor_noaa, /nodata, yrange = [ 2 , 5 ], xrange = [ 1980 , 2016 ], title = sim_title
cgplot, noaa_time, noaa_ihr, /overplot, psym = 2, err_ylow = noaa_ihr_err1, err_yhigh = noaa_ihr_err1, symsize = 1.2, $
	color = 'blue'
cgplot, ss_time, ss_ihr, /overplot, psym = 5, err_ylow = ss_ihr_err1, err_yhigh = ss_ihr_err1, symsize = 1.2, $
	color = 'red'
cgplot, ogi_time, ogi_ihr, /overplot, psym = 4, err_ylow = ogi_ihr_err1, err_yhigh = ogi_ihr_err1, symsize = 1.2, $
	color = 'forest green'
;cgplot, noaa_time, noaa_ihr_sim, /overplot, psym = -3, color = 'blue'
;cgplot, ss_time, ss_ihr_sim, /overplot, psym = -3, color = 'red'
;cgplot, ogi_time, ogi_ihr_sim, /overplot, psym = 5, color = 'forest green'
cgplot, all_time, global_ihr, /overplot, color = 'black'
cgplot, all_time, global_ihr_ss, /overplot, color = 'blue', linestyle = 2
cgplot, all_time, global_ihr_noaa, /overplot, color = 'red', linestyle = 2
cgplot, all_time, global_ihr_ogi, /overplot, color = 'forest green', linestyle = 2

AL_Legend, ['NOAA IHR', 'UCI IHR', 'OGI IHR', 'NOAA sim IHR', 'UCI sim IHR', 'OGI sim IHR', 'Global sim IHR'], $
	color = ['blue', 'red', 'forest green', 'blue', 'red', 'forest green', 'black'], $
	psym = [2, 5, 4, -3, -3, -3, -3], $
	linestyle = [0, 0, 0, 2, 2, 2, 0], /box, background_color = 'rose', position = [1981, 3]
