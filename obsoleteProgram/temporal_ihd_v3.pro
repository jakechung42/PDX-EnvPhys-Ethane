...
sim03_year_gb_avg = findgen (34) + 1981
for j = 0, n_elements(sim03_year_gb_avg) - 1 do begin
	print, j
	for i = 0, n_elements(bin01_noaa[0 , *]) - 1 do begin
		for t = 0, nt - 1 do begin
			data= CTM_EXTRACT( *(datainfo[t].data), modelinfo=modelinfo, $
		...
		sim_bin01_var_noaa_03[ i ] = mean(globalavg[ where(sim_yymmdd.year eq sim03_year_gb_avg[ j ] ) ] )
	endfor
endfor

;This is a special part that is only in v2 and v3 of this script
;make an array to store the data for Aydin et al scenario global average
sim03_global_avg_nor = fltarr(nt) 
sim03_global_avg_sou = fltarr(nt)
for t = 0, nt - 1 do begin
	print, t
	data= CTM_EXTRACT( *(datainfo[t].data), modelinfo=modelinfo, $
	gridinfo= gridinfo, lat= [ 0 , 70 ], $
	lon= [ -180 , 180 ], alrange = [1, 3], average=7)
	sim03_global_avg_nor[ t ]= data/2 * 1000
endfor

for t = 0, nt - 1 do begin
	print, t
	data= CTM_EXTRACT( *(datainfo[t].data), modelinfo=modelinfo, $
	gridinfo= gridinfo, lat= [ -30 , 0 ], $
	lon= [ -180 , 180 ], alrange = [1, 3], average=7)
	sim03_global_avg_sou[ t ]= data/2 * 1000
endfor
...
;Because the NOAA data is not sorted latitudinally, the next part will do the sorting in order to keep it consistent for the entire script
...
print, bin01_noaa[ 2 , where( bin01_noaa[ 0 , * ] LT 0 ) ]
...
xtitle = 'Years'
cgPlot, nor_ss, /nodata, xrange = [ 1980 , 2016 ], xtitle = 'Years', yrange = [ 0 , 2000 ], $
	xStyle = 8, position = [0.15, 0.15, 0.9, 0.50], charsize = 2, $
	ytitle = 'Ethane mixing ratio (pptv)'

;plot nor hemisphere NOAA sim
cgPlot, year_series_noaa_sim, nor_noaa_sim, color = 'violet', /overplot, /NoErase, linestyle = 0, thick = 2.0
...
cgPlot, year_series_ss, nor_ss_sim, color = 'violet', /overplot, /NoErase, linestyle = 0, thick = 2.0
...
cgPlot, year_series_ogi, nor_ogi_sim, color = 'violet', /overplot, /NoErase, linestyle = 0, thick = 2.0
...
cgPlot, year_series_noaa_sim, nor_noaa_sim_01, color = 'forest green', /overplot, /NoErase, linestyle = 0, thick = 2.0
...
cgPlot, year_series_ogi, nor_ogi_sim_01, color = 'forest green', /overplot, /NoErase, linestyle = 0, thick = 1.5, psym = 2
...
cgPlot, year_series_ss, nor_ss_sim_01, color = 'forest green', /overplot, /NoErase, linestyle = 0, thick = 2.0
...
cgPlot, year_series_noaa_sim, nor_noaa_sim_02, color = 'tomato', /overplot, /NoErase, linestyle = 0, thick = 2.0
...
cgPlot, year_series_ogi, nor_ogi_sim_02, color = 'tomato', /overplot, /NoErase, linestyle = 0, thick = 1.5, psym = 2
...
cgPlot, year_series_ss, nor_ss_sim_02, color = 'tomato', /overplot, /NoErase, linestyle = 0, thick = 2.0
...
cgPlot, year_series_noaa_sim, nor_noaa_sim_03, color = 'brown', /overplot, /NoErase, linestyle = 0, thick = 2.0
...
cgPlot, year_series_ogi, nor_ogi_sim_03, color = 'brown', /overplot, /NoErase, linestyle = 0, thick = 1.5, psym = 2
...
cgPlot, year_series_ss, nor_ss_sim_03, color = 'brown', /overplot, /NoErase, linestyle = 0, thick = 2.0
...
cgPlot, year_series_noaa_sim, nor_noaa_sim_04, color = 'maroon', /overplot, /NoErase, linestyle = 0, thick = 2.0
...
cgPlot, year_series_ogi, nor_ogi_sim_04, color = 'maroon', /overplot, /NoErase, linestyle = 0, thick = 1.5, psym = 2
...
cgPlot, year_series_ss, nor_ss_sim_04, color = 'maroon', /overplot, /NoErase, linestyle = 0, thick = 2.0
...
cgPlot, year_series_noaa_sim, nor_noaa_sim_05, color = 'gray', /overplot, /NoErase, linestyle = 0, thick = 2.0
...
cgPlot, year_series_ogi, nor_ogi_sim_05, color = 'gray', /overplot, /NoErase, linestyle = 0, thick = 1.5, psym = 2
...
cgPlot, year_series_ss, nor_ss_sim_05, color = 'gray', /overplot, /NoErase, linestyle = 0, thick = 2.0
...
sim03_gb_annual_nor_var = fltarr (n_elements(sim03_year_gb_avg))
sim03_gb_annual_sou_var = fltarr (n_elements(sim03_year_gb_avg))
sim03_diff_annual_var = fltarr (n_elements(sim03_year_gb_avg))
sim03_diff_global = sim03_global_avg_nor - sim03_global_avg_sou
for i = 0, n_elements(sim03_year_gb_avg) - 1 do begin
	temp_idx = where (sim_yymmdd.year eq sim03_year_gb_avg[ i ])
	sim03_gb_annual_nor_var[ i ] = mean (sim03_global_avg_nor[ temp_idx ])
	sim03_gb_annual_sou_var[ i ] = mean (sim03_global_avg_sou[ temp_idx ])
	sim03_diff_annual_var[ i ] = mean (sim03_diff_global[ temp_idx ])
endfor
tau0 = tau0/8760 + 1985
cgPlot, tau0, sim03_global_avg_nor, color = 'black', /overplot, /NoErase
cgPlot, tau0, sim03_global_avg_sou, color = 'black', /overplot, /NoErase
cgPlot, sim03_year_gb_avg, sim03_gb_annual_nor_var, color = 'black', /overplot, /NoErase
cgPlot, sim03_year_gb_avg, sim03_gb_annual_sou_var, color = 'black', /overplot, /NoErase
...
cgPlot, year_series_ogi, diff_ogi, psym = 14, XTickformat = '(A1)', $
	position = [0.15 , 0.52 , 0.9 , 0.9], color = 'black', xrange = [ 1980 , 2016 ], /NoErase, yrange = [ 400, 2000], $
...
cgPlot, tau0, sim03_diff_global, color = 'black', /overplot, /NoErase
cgPlot, sim03_year_gb_avg, sim03_diff_annual_var, /overplot, /NoErase, color = 'black'
sim03_diff_annual_var_2 = sim03_gb_annual_nor_var - sim03_gb_annual_sou_var
cgPlot, sim03_year_gb_avg, sim03_diff_annual_var_2, color = 'black', /overplot, /NoErase
...
cgLEGEND, title = ['Base emission (Xiao et al.)', 'Rice et al. normalized', 'Rice et al.', 'Aydin et al. normalized', 'Aydin et al.', 'Simpson et al.'], $
	/Box, /Background, BG_Color = 'rose', location = [0.5, 0.90], $
