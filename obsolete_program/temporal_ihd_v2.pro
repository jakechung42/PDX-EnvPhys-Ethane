...
bin01_ogi_pfit = poly_fit( bin01_ogi [ 0 , * ] , bin01_ogi [ 1 , * ], 4, measure_errors = measure_errors, $
...
;this part calculate the annual averages of the simulated data to compare with the simulated data extracted from the stations
;coordinates
